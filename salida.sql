...
-- Lock Database
UPDATE DATABASECHANGELOGLOCK SET LOCKED = 1, LOCKEDBY = 'ITLQBPOCRVAR (192.168.11.163)', LOCKGRANTED = '2021-12-06T17:19:57.697' WHERE ID = 1 AND LOCKED = 0
GO

-- Rolling Back ChangeSet: samplechangelog.sql::1::script
drop table users
GO

DELETE FROM DATABASECHANGELOG WHERE ID = '1' AND AUTHOR = 'script' AND FILENAME = 'samplechangelog.sql'
GO
